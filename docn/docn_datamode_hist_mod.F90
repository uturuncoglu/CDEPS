module docn_datamode_hist_mod
  ...
  public  :: docn_datamode_hist_advertise
  public  :: docn_datamode_hist_init_pointers
  public  :: docn_datamode_hist_advance
  public  :: docn_datamode_hist_restart_read
  public  :: docn_datamode_hist_restart_write
...
!===============================================================================
  ...
  subroutine docn_datamode_hist_advertise(exportState, fldsexport, flds_scalar_name, rc)
  ...
  end subroutine docn_datamode_hist_advertise

  !===============================================================================
  subroutine docn_datamode_hist_init_pointers(exportState, rc)
    ...
    if (chkerr(rc,__LINE__,u_FILE_u)) return
    call dshr_state_getfldptr(exportState, 'So_dhdx'  , fldptr1=So_v     , allowNullReturn=.true., rc=rc)
    if (chkerr(rc,__LINE__,u_FILE_u)) return
    call dshr_state_getfldptr(exportState, 'So_dhdy'  , fldptr1=So_v     , allowNullReturn=.true., rc=rc)
    if (chkerr(rc,__LINE__,u_FILE_u)) return
    call dshr_state_getfldptr(exportState, 'Fioo_q'   , fldptr1=So_v     , allowNullReturn=.true., rc=rc)
    if (chkerr(rc,__LINE__,u_FILE_u)) return

  end subroutine docn_datamode_hist_init_pointers

  !===============================================================================
  subroutine docn_datamode_hist_advance(rc)

    ! input/output variables
    integer, intent(out)   :: rc

    ! local variables
    character(len=*), parameter :: subname='(docn_datamode_hist_advance): '
    !-------------------------------------------------------------------------------

    rc = ESMF_SUCCESS

  end subroutine docn_datamode_hist_advance

  !===============================================================================
  subroutine docn_datamode_hist_restart_write(case_name, inst_suffix, ymd, tod, &
  ...
  end subroutine docn_datamode_hist_restart_write

  !===============================================================================
  subroutine docn_datamode_hist_restart_read(rest_filem, inst_suffix, logunit, my_task, mpicom, sdat)
  ...
  end subroutine docn_datamode_hist_restart_read

end module docn_datamode_hist_mod
